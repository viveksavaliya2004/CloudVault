                        ...
                        <div className="p-1 space-y-0.5">
                          ...
                          {user?.role === 'admin' && (
                            <Link
                              to="/admin"
                              onClick={() => setProfileDropdownOpen(false)}
                              className="flex items-center gap-2 px-3 py-2 text-xs font-bold text-violet-600 hover:text-violet-900 hover:bg-slate-100 dark:text-violet-400 dark:hover:text-white dark:hover:bg-slate-800/80 rounded-xl transition-colors"
                            >
