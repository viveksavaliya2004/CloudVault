...
import {
  ...
  Activity, Clock, UserCheck, UserX, Calendar
} from 'lucide-react';
          ...
          <div className="flex-1 w-full space-y-6">
            ...
            {subTab === 'usage' && (
              <div className="space-y-6 w-full">
                ...
                <div className="flex items-center justify-between gap-4 flex-wrap bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 shadow-sm transition-colors duration-300">
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <div className="relative flex items-center">
                      ...
                      <input
                        ...
                        className="pl-9 pr-3 py-2 text-xs font-semibold rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500/40 cursor-pointer shadow-2xs"
                      />
                    </div>
                    ...
                    <div className="relative flex items-center">
                      ...
                      <input
                        ...
                        className="pl-9 pr-3 py-2 text-xs font-semibold rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-1 focus:ring-indigo-500/40 cursor-pointer shadow-2xs"
                      />
                    </div>
                  ...
                  <button
                    ...
                    className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl px-5 py-2 text-xs font-bold transition-all shadow-xs hover:shadow-md cursor-pointer flex items-center gap-2"
                  >
